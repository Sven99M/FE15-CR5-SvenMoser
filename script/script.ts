...
class animal {
    ...
    class Cat extends animal{
        ...
        furColor: string;
        URLBreed: string;
        constructor(name: string, gender: string, size:string, age:number, vaccine: boolean,image : string,breed : string,furColor:string,URLBreed:string){
    ...
    class Dog extends animal{
        ...
        training: string;
        URLBreed: string;
        constructor(name: string, gender: string, size:string, age:number, vaccine: boolean,image : string,breed : string,training:string,URLBreed:string){
            super(name, gender, size, age, vaccine,image)
            this.breed = breed;
